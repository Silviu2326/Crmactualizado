...
function StatCard({ 
  ...
  return (
    <div className={`rounded-xl shadow-sm p-6 transition-all duration-300 hover:scale-105 bg-gradient-to-br ${bgGradient} border border-white/50 hover:shadow-lg group`}>
      <div className="flex items-center">
        <div className={`flex-shrink-0 p-3 rounded-xl ${iconBg} ring-4 ring-white/50 transition-transform duration-300 group-hover:rotate-12`}>
          {icon}
        </div>
