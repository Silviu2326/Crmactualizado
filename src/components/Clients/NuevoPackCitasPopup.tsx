      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Nuevo Pack de Citas</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="numeroCitas" className="block text-sm font-medium text-gray-700 dark:text-gray-200">
                  Número de Citas
                </label>
                <input
                  type="number"
