...
import EditPlanningPageCalendario from './EditPlanningPageCalendario';
import VistaSimplificada from './VistaSimplificada';
...
const EditPlanningPage: React.FC = () => {
  ...
  const [vistaActual, setVistaActual] = useState<'simplificada' | 'compleja' | 'calendario' | 'resumen'>('simplificada');
